...
<head>
    ...
    <title>24h Notícias —Entendimento</title>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">24h Entedimento</div>
                </div>
<?php
      ...
      $articlesName = $urlSourcesArray['articles'][$i];
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        ...
                        <div class="flag flag-trending">Entendimento</div>
